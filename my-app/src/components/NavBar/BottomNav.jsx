...
useEffect(() => {
  ...
  return (
        ...
        <>
            <div className={`max-lg:hidden z-50 nav-bottom transition-all duration-200 ease-in-out ${Fixed ? 'fixed top-0 right-0 left-0 w-full' : 'relative'} `}>
                ...
                <div className="top-box h-10 text-mainColor border-b-[1px] border-solid border-b-borderColor">
                    ...
                    <div className="container h-full mx-auto flex justify-between items-center text-xs font-normal" >
                        ...
                        <div className="top-box-links">
                            <NavLink to='about' className='pr-3 capitalize'>about us</NavLink>
                            <NavLink to='/compare' className='pr-3 capitaliz'>Compare</NavLink>
                            <NavLink to='/wish' className='pr-3 capitalize'>Wish list</NavLink>
                        </div>
                    ...
                    <div className="container mx-auto h-full flex items-center justify-between">
                                    ...
                                    <ul className='flex flex-col gap-3'>
                                    {
                                        searchedData.map((product,index) => {
                                            return(
                                                ...
                                                >
                                                    <img src={product.image} alt="pic" className='w-[40px] h-[40px] rounded-[2px]' />
                                                    <p className="tit dosis text-sm font-semibold capitalize text-black">{product.title}</p>
                                                </li>)
                                        }) 
                        ...
                        <div className="user-box flex items-center gap-4">
                            ...
                            <div className="log-In-Out">
                                <NavLink to='signUp' className="In w-[42px] h-[42px] border-[1px] border-solid border-borderColor rounded-full flex justify-center items-center cursor-pointer">
                            ...
                            <div className="totalPrice">
                                <p className="dosis text-mainColor font-semibold text-base">$<span className="total">0.00</span></p>
                            </div>

                            <div className="shopping-icon w-[42px] h-[42px] rounded-full bg-lightRed relative flex justify-center items-center">
                                <BsBasket3 className="text-darkRed" />
                                <span className="items-num absolute h-[17px] w-[17px] rounded-full bg-darkRed text-textWhite text-[10px] font-normal leading-[15px] text-center top-[-5px] right-0">0</span>
                            </div>
                        </div>
                ...
                <div className="bottom-box border-b-[1px] border-solid border-b-borderColor h-[63px]">
                    <div className="container mx-auto flex h-full justify-between items-center relative">
                        ...
                        <div className="categories text-[15px] font-semibold flex items-center rounded-[40px] px-5 relative h-[50px] bg-primary text-textWhite cursor-pointer transition-all duration-500 ease-linear" onClick={() => handelCategoriesMenu()}>
                            ...
                            <span className="dosis absolute bg-borderColor text-mainColor px-4  w-fit font-semibold text-[10px] uppercase  rounded-3xl bottom-[-2px] left-[45px]">total 50 products</span>
                        </div>
            ...
            {/* ============Mobile Nav============ */}
            <div className={`nav-bottom z-50 lg:hidden py-5 border-b-[1px] border-solid border-b-borderColor ${Fixed ? 'fixed top-0 right-0 left-0 w-full' : 'relative'}`}>

                <div className="container mx-auto flex justify-between items-center">

                    <button className="menu-btn cursor-pointer border-[1px] border-solid border-borderColor rounded-[5px] text-lightGray p-2" onClick={handelOpenNav}>
                        <FaBars />
                    </button>
