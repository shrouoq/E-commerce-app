...
let handleSignIn = async(e)=>{
    ...
    setLoading(true)
    try{
        let result = await signUpNewUser(userDetails.userName, userDetails.email, userDetails.password)
        if(result) {
      ...
      <form className=" " onSubmit={handleSignIn}>
        <div className="flex flex-col @md:flex-row">
          <div className="">
            ...
            <div className="gap-y-8 sm:grid-cols-6 flex flex-col justify-center p-8">
              ...
              <div className="sm:col-span-4 ">
                ...
                <div className="mt-2">
                  <input  id="userName"  type="text" name="userName" onChange={handleChange} autoFocus 
              ...
              <div className="sm:col-span-4">
                <label htmlFor="email" className="block text-2xl font-medium text-gray-900">Email address </label>
                <div className="mt-2">
              ...
              <div className="sm:col-span-4">
                <label htmlFor="last-name" className="block text-2xl font-medium text-gray-900">
                  Password
                </label>
                <div className="mt-2">
          ...
          >
            ...
            <p className=" text-center">Already have account? <Link className="text-green-600 font-bold" to={'/signin'}>Sign In</Link></p>
            </div>
