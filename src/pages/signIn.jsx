...
export default function SignIn() {
  ...
  return (
<div className="max-w-4xl mx-auto mt-5 mb-5 shadow-2xl ring-1 ring-gray-900/10 rounded-xl sm:px-6 lg:px-8 lg:py-8 w-full">
  <form className=" " onSubmit={handleSignIn}>
        <div className="flex flex-col @md:flex-row">
            <p className=" mt-3 text-6xl font-bold text-center">Sign In</p>
